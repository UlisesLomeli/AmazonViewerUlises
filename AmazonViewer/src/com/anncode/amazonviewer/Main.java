...
/**
 * <h1>AmazonViewer</h1> AmazonViewer es un programa que permite vizualizar
 * Movies, Series con sus capitulos, Books y Magazines. Te permite generar
 * reportes generales y con fecha del dia.
 * <p>
 * Existen algunas reglas como que todos los elementos pueden ser vsualizados o
 * leidos de los Magazines.
 * 
 * @author Ulises
 * @version 1.1
 * @since 2021
...
public class Main {
	...
	public static void showChapters(ArrayList<Chapter> chaptersOfSerieSelected) {
		...
		do {
			...
			// Leer Respuesta usuario
			int response = AmazonUtil.validateUserResponseMenu(1, chaptersOfSerieSelected.size());
			...
			if (response > 0) {
				Chapter chapterSelected = chaptersOfSerieSelected.get(response);
